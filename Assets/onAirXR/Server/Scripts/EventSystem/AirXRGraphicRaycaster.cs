...
public class AirXRGraphicRaycaster : GraphicRaycaster {
    private static readonly List<AirXRGraphicRaycaster> _allRaycasters = new List<AirXRGraphicRaycaster>();

    public static List<AirXRGraphicRaycaster> GetAllRaycasters() {
