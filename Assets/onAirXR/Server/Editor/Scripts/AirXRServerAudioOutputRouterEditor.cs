...
[CustomEditor(typeof(AirXRServerAudioOutputRouter))]
public class AirXRServerAudioOutputRouterEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (propInput.enumValueIndex == (int)AirXRServerAudioOutputRouter.Input.AudioPlugin) {
        ...
        if (propOutput.enumValueIndex == (int)AirXRServerAudioOutputRouter.Output.One) {
            EditorGUILayout.BeginVertical("Box");
