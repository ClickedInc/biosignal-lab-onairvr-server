...
//    private MotionPredictionPlaybackCapture captureManager;
...
//    private PlaybackMode _playbackMode = PlaybackMode.Predict_NoTimeWarp;
...
//    public void Configure(MotionPredictionPlayback owner, Camera cameraPrefab) {
//        playbackCameras[0] = createChild("LeftEyeCamera", cameraPrefab.gameObject).GetComponent<Camera>();
//        playbackCameras[1] = createChild("RightEyeCamera", cameraPrefab.gameObject).GetComponent<Camera>();

//        Time.captureFramerate = 60; // TODO can be another value
...
//        captureManager = captureModule.GetComponent<MotionPredictionPlaybackCapture>();
...
//    private async void runEndOfFrameLoop() {
...
//    private GameObject createChild(string name, GameObject prefab = null) {
//        var go = prefab != null ? Instantiate(prefab) : new GameObject(name);
...
//        if (playbackState == PlaybackState.Playing) {
//            Simulate(captureNum, _playbackMode, false);
//        }
//        else if (playbackState == PlaybackState.Capturing) {
//            Simulate(captureNum, _playbackMode, true);
